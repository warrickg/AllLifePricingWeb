                    ...
                    <script type="text/javascript">                       
                        ...
                        function CheckQualifyButton() {
                            ...
                            if (element != null) // && element.value == '')
                            {
                                ...
                                if ((document.getElementById("<%=RadioButtonHbA1c4.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c6.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c7.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c8.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c9.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c10.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c11.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c12.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1c15.ClientID%>").checked == false) && (document.getElementById("<%=RadioButtonHbA1cUnknown.ClientID%>").checked == false)) {
